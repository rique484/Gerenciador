 ...
 * @author rique
 */
public class OrderPend extends javax.swing.JFrame {

    /**
     * Creates new form OrderPend
     */
    public OrderPend() {
        initComponents();
        ...
        ResultSet rs = null;
        String sql = "select idpedido as 'Venda',num_comanda as 'Comanda' from pedido where status=0";
        try {
            conexao = new ConfigDB().conector();
            pst = conexao.prepareStatement(sql);
            rs = pst.executeQuery();
                tblPend.setModel(DbUtils.resultSetToTableModel(rs));
                conexao.close();   
