...
import com.app.gerecia.config.Mail;
 ...
 * @author rique
 */
public final class MailStatus extends javax.swing.JFrame {

    private Thread th;
    private String smtp, port, from, pass, name, to, protocol;

    public MailStatus(String dest, String protc) {
        initComponents();
        to = dest;
        protocol = protc;
        loadMail();
        send().start();
        jTextArea1.setText("Efetuando o envio....");
    ...
    private final Runnable t1 = new Runnable() {
        @Override
        public void run() {
            jTextArea1.setText(new Mail().send(smtp, from, port, pass,
                    "SYScon", to, "Pedido " + protocol + " recebido", "Seu pedido foi recebido(" + protocol + "), e em breve ficara"
                    + " pronto para entrega."));
            th.interrupt();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Status do envio de email");
